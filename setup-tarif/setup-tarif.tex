...
\def\begintt{%
  ...
  %%%%%%%%%%%%%
  \ttlineno=0\everypar={\advance\ttlineno by1\rlap{\kern13pt\llap{\the\ttlineno:}}}\begtt}
\def\begtt{%
  %%%%%%%%%%%%%
  \ifx\islinenumprinted+%
  \everypar={\advance\ttlineno by1 \space\hbox to13pt{\hss\the\ttlineno:\kern4pt}}%
  %                                ^^^^^^ for compatibility with docmy and
  % when you delete this, compensate kern below (помечено HERE) using tracingoutput
  \else\everypar={\kern17pt}\fi
  %%%%%%%%%%%%%

...
\rightline{\eightrm
  ...
  \count255=\time \divide\count255 by60 \ifnum\count255<10 0\fi\number\count255
...
\advance\secnum by1 \subsecnum=0
\noindent\rectangle{16pt}{9pt}{25pt}{\bbbf\the\secnum}%
\kern5pt{\bbbf Обзор системы тарификации}\par
\nobreak\medskip
...
\item{} {\tt https://192.168.8.4/tarif} \quad {\eightrm получение информации по произвольным параметрам}
\item{} {\tt https://192.168.8.4/otdel} \quad {\eightrm получение информации по отделам}
...
\advance\secnum by1 \subsecnum=0
\noindent\rectangle{16pt}{9pt}{25pt}{\bbbf\the\secnum}%
\kern5pt{\bbbf Тарификационная база данных}\par
\nobreak\medskip
...
\kern5pt{\bbf Настройка операционной системы}\par
\nobreak\smallskip
\medskip
...
\noindent\vbox to0pt{\vss
  \rectangle{16pt}{9pt}{25pt}{\bf\the\secnum.\the\subsecnum}\kern-5pt}%
\kern5pt{\bbf Создание базы данных}\par
\nobreak\smallskip
\medskip
...
\noindent\vbox to0pt{\vss
  \rectangle{16pt}{9pt}{25pt}{\bf\the\secnum.\the\subsecnum}\kern-5pt}%
\kern5pt{\bbf Настройка тестовой машины}\par
\nobreak\smallskip
\medskip
...
\advance\secnum by1 \subsecnum=0
\noindent\rectangle{16pt}{9pt}{25pt}{\bbbf\the\secnum}%
\kern5pt{\bbbf Обновление таблицы справочника в базе}\par
\nobreak\medskip
...
\noindent\vbox to0pt{\vss
  \rectangle{16pt}{9pt}{25pt}{\bf\the\secnum.\the\subsecnum}\kern-5pt}%
\kern5pt{\bbf Создание таблицы}\par
\nobreak\smallskip
\medskip
...
\noindent\vbox to0pt{\vss
  \rectangle{16pt}{9pt}{25pt}{\bf\the\secnum.\the\subsecnum}\kern-5pt}%
\kern5pt{\bbf Заполнение таблицы}\par
\nobreak\smallskip
\medskip
...
\advance\secnum by1 \subsecnum=0
\noindent\rectangle{16pt}{9pt}{25pt}{\bbbf\the\secnum}%
\kern5pt{\bbbf Настройка web-сервера}\par
\nobreak\medskip
...
\noindent\vbox to0pt{\vss
  \rectangle{16pt}{9pt}{25pt}{\bf\the\secnum.\the\subsecnum}\kern-5pt}%
\kern5pt{\bbf Настройка Apache}\par
\nobreak\smallskip
\medskip
...
\advance\secnum by1 \subsecnum=0
\noindent\rectangle{16pt}{9pt}{25pt}{\bbbf\the\secnum}%
\kern5pt{\bbbf Программы для занесения тарификации в БД}\par
\nobreak\medskip
